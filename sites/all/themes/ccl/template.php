...
function ccl_preprocess_maintenance_page(&$variables, $hook) {
  // When a variable is manipulated or added in preprocess_html or
  // preprocess_page, that same work is probably needed for the maintenance page
  // as well, so we can just re-use those functions to do that work here.
  ccl_preprocess_html($variables, $hook);
  ccl_preprocess_page($variables, $hook);
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function ccl_preprocess_html(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function ccl_preprocess_node(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');

  // Optionally, run node-type-specific preprocess functions, like
  // ccl_preprocess_node_page() or ccl_preprocess_node_story().
 ...
 */
/* -- Delete this line if you want to use this function
function ccl_preprocess_comment(&$variables, $hook) {
  $variables['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function ccl_preprocess_region(&$variables, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function ccl_preprocess_block(&$variables, $hook) {
